...
public class tut_graph_p2 {
    public static void main(String[] args) throws Exception {
        ...
        Bridges bridges = new Bridges(9, "amanw", System.getenv("API_KEY"));
        ...
        for (String actor : graph.getVertices().keySet())
            for (SLelement<Edge<String, String>> sle = graph.getAdjacencyList(actor); sle != null; sle = sle
                    .getNext()) {
                Edge<String, String> edge = sle.getValue();
                String concat = edge.getFrom() + " " + edge.getTo();
                graph.getLinkVisualizer(edge.getFrom(), edge.getTo()).setLabel(concat);
            }
