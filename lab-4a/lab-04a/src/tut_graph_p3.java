...
public class tut_graph_p3 {
    public static void main(String[] args) throws Exception {
        ...
        Bridges bridges = new Bridges(10, "amanw", System.getenv("API_KEY"));
        ...
        bridges.setDescription(
                "Demonstrate advanced features of graphs, traversal of adjacency lists, use of iterators");
        ...
        // using core BRIDGES classes to print the movies that Kevin Bacon is adjacent
        // to
        System.out.println("Using core Bridges classes:");
        for (SLelement<Edge<String, String>> sle = graph.getAdjacencyList(kevin_bacon); sle != null; sle = sle
                .getNext()) {
